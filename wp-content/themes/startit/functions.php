...
if( !function_exists('qode_startit_sidebar_layout') ) {
    ...
    function qode_startit_sidebar_layout() {
        ...
        if(get_post_meta(qode_startit_get_page_id(), "qodef_sidebar_meta", true) != ''){
            $sidebar_layout = get_post_meta(qode_startit_get_page_id(), "qodef_sidebar_meta", true);
        }else{
...
if( !function_exists('qode_startit_container_style') ) {
    ...
    function qode_startit_container_style($style) {
        ...
        $container_selector = array(
            '.page-id-' . $id . ' .qodef-wrapper-inner',
            '.page-id-' . $id . ' .qodef-content'
        );
