...
if (!function_exists('qode_startit_register_footer_sidebar')) {
	...
	function qode_startit_register_footer_sidebar() {
		...
		register_sidebar(array(
			...
			'description' => 'Footer Bottom Right - VVPLOCKER.COM',
			'before_widget' => '<div id="%1$s" class="widget qodef-footer-bottom-left %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<h4 class="qodef-footer-widget-title">',
			'after_title' => '</h4>'
...
if (!function_exists('qode_startit_get_content_bottom_area')) {
	...
	function qode_startit_get_content_bottom_area() {
		...
		$parameters['content_bottom_area'] = qode_startit_get_meta_field_intersect('enable_content_bottom_area');
		if ($parameters['content_bottom_area'] == 'yes') {
			//Sidebar for content bottom area
			$parameters['content_bottom_area_sidebar'] = qode_startit_get_meta_field_intersect('content_bottom_sidebar_custom_display');
			//Content bottom area in grid
			$parameters['content_bottom_area_in_grid'] = qode_startit_get_meta_field_intersect('content_bottom_in_grid');
			//Content bottom area background color
			$parameters['content_bottom_background_color'] = 'background-color: '.qode_startit_get_meta_field_intersect('content_bottom_background_color');
		}
