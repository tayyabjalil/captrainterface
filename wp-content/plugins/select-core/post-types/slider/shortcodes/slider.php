                ...
                while (have_posts()) : the_post();
                    ...
                    if (get_post_meta(get_the_ID(), "qodef_slide_content_vertical_middle", true) == "yes") {
                        ...
                        if (get_post_meta(get_the_ID(), "qodef_slide_content_top", true) != "") {
                            $content_yaxis_start = "top:" . esc_attr(get_post_meta(get_the_ID(), "qqodef_slide_content_top", true)) . "%;";
                    ...
                    if (get_post_meta(get_the_ID(), "qodef_slide_subtitle", true) != "") {
                        ...
                        $html_text .= '<h3 class="qodef-slide-subtitle"><span>' . wp_kses_post(get_post_meta(get_the_ID(), 'qodef_slide_subtitle', true)) . '</span></h3>';
                        $html_text .= '</div>';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "qodef_slide_hide_title", true) == 'no') {
                        $html_text .= '<div class="qodef-el">';
                        $html_text .= '<h2 class="qodef-slide-title">';

                        if(get_post_meta(get_the_ID(), "qodef_slide_title_link", true) != '') {
                            $html_text .= '<a href="'.esc_url(get_post_meta(get_the_ID(), "qodef_slide_title_link", true)).'" target="'.esc_attr(get_post_meta(get_the_ID(), "qodef_slide_title_target", true)).'">';
                        }
                        $html_text .= '<span>'.wp_kses_post($title).'</span>';
                        if(get_post_meta(get_the_ID(), "qodef_slide_title_link", true) != '') {
                            $html_text .= '</a>';
                        }
                    ...
                    if (get_post_meta(get_the_ID(), "qodef_slide_text", true) != "") {
                        $html_text .= '<div class="qodef-el">';
                        $html_text .= '<h3 class="qodef-slide-text"><span>'.wp_kses_post(get_post_meta(get_the_ID(), "qodef_slide_text", true)).'</span></h3>';
                        $html_text .= '</div>';
                    }
