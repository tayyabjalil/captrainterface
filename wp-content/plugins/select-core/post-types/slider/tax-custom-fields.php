...
function qode_slides_category_taxonomy_custom_fields($tag) {
    ...
    <tr class="form-field">
        ...
        <td>
            <select name="term_meta[header_effect]" id="term_meta[header_effect]">
                <option <?php if(isset($term_meta['header_effect']) && $term_meta['header_effect'] == 'no' ){ echo "selected='selected'"; } ?> value="no">No</option>
                <option <?php if(isset($term_meta['header_effect']) && $term_meta['header_effect'] == 'yes' ){ echo "selected='selected'"; } ?> value="yes">Yes</option>
            </select>
        </td>
    </tr>
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Effect on navigation (dark/light style)', 'select-core'); ?></label>
        </th>
        <td>
            <select name="term_meta[navigation_effect]" id="term_meta[navigation_effect]">
                <option <?php if(isset($term_meta['navigation_effect']) && $term_meta['navigation_effect'] == 'no' ){ echo "selected='selected'"; } ?> value="no">No</option>
                <option <?php if(isset($term_meta['navigation_effect']) && $term_meta['navigation_effect'] == 'yes' ){ echo "selected='selected'"; } ?> value="yes">Yes</option>
            </select>
        </td>
    </tr>
    <tr class="form-field">
    ...
    <tr class="form-field">
        ...
        <td>
            <input type="text" name="term_meta[shortcode]" id="term_meta[shortcode]" size="25" style="width:60%;" value="<?php echo esc_attr($tag->slug) ? "[qodef_slider slider='".$tag->slug."' auto_start='yes' animation_type='slide' slide_animation_timeout='6000' height='' responsive_height='yes' responsive_breakpoints='set1' show_navigation_arrows='yes' show_navigation_circles='yes']" : ""; ?>" readonly><br />
...
function qode_manage_theme_columns($out, $column_name, $theme_id) {
    ...
    switch ($column_name) {
        case 'shortcode':
            $out .= "[qodef_slider slider='".$theme->slug."' auto_start='yes' animation_type='slide' slide_animation_timeout='6000' height='' responsive_height='yes' responsive_breakpoints='set1' show_navigation_arrows='yes' show_navigation_circles='yes']";
            break;
